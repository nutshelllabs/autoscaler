...
/*
 * Stepwise with cautious scale in scaling method
 *
...
function calculateSize(spanner) {
  return baseModule.loopThroughSpannerMetrics(spanner, (spanner, metric) => {
    ...
    var scaleinSize = stepSize < 1000
      ? Math.min(200, stepSize)
      : (spanner.currentSize > 4000 ? spanner.currentSize - 4000 : stepSize);
    var suggestedStep =
